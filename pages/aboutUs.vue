...
.title-background {
  background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.4)), url("assets/images/sede.jpg");
...
@media (max-width: 768px) {
  ...
  .title-background {
    background: linear-gradient(0deg, rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.4)), url("assets/images/sede.jpg");
    align-items: center;
    text-align: center;
  }
